...
func (p MosquittoPubSub) NewHCSR501Listener(ctx context.Context, listenerName string, subscription string) error {
	...
	var f mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
		...
		// unmashal payload
		sensor := &sensors.HCSR501Measurement{}
		...
		if err == nil {
			err = p.persistence.CreateHCSR501Measurement(ctx, sensor)
