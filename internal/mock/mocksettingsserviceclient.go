...
// Source: internal/pb/devices/settings_grpc.pb.go
...
func (m *MockSettingsServiceClient) CreateBatCaveSetting(ctx context.Context, in *devices_pb.CreateBatCaveSettingRequest, opts ...grpc.CallOption) (*devices_pb.CreateBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*devices_pb.CreateBatCaveSettingResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSettingsServiceClient) GetBatCaveSetting(ctx context.Context, in *devices_pb.GetBatCaveSettingRequest, opts ...grpc.CallOption) (*devices_pb.GetBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*devices_pb.GetBatCaveSettingResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSettingsServiceClient) UpdateBatCaveSetting(ctx context.Context, in *devices_pb.UpdateBatCaveSettingRequest, opts ...grpc.CallOption) (*devices_pb.UpdateBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*devices_pb.UpdateBatCaveSettingResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CreateBatCaveSetting mocks base method.
func (m *MockSettingsServiceServer) CreateBatCaveSetting(arg0 context.Context, arg1 *devices_pb.CreateBatCaveSettingRequest) (*devices_pb.CreateBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
...
// GetBatCaveSetting mocks base method.
func (m *MockSettingsServiceServer) GetBatCaveSetting(arg0 context.Context, arg1 *devices_pb.GetBatCaveSettingRequest) (*devices_pb.GetBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
...
// UpdateBatCaveSetting mocks base method.
func (m *MockSettingsServiceServer) UpdateBatCaveSetting(arg0 context.Context, arg1 *devices_pb.UpdateBatCaveSettingRequest) (*devices_pb.UpdateBatCaveSettingResponse, error) {
	m.ctrl.T.Helper()
