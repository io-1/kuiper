...
func (e SensorsListenersEnv) NewBH1750Listener(listenerName string, urlString string) (*listeners.Listener, error) {
	...
	var f mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
		...
		// unmashal payload
		measurement := &sensors.BH1750Measurement{}
		...
		if err == nil {
			err = e.persistence.CreateBH1750Measurement(measurement)
