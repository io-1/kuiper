...
func (p MosquittoPubSub) NewMC38Listener(ctx context.Context, listenerName string, subscription string) error {
	...
	var f mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
		...
		// unmashal payload
		sensor := &sensors.MC38Measurement{}
		...
		if err == nil {
			err = p.persistence.CreateMC38Measurement(ctx, sensor)
