...
func (e SensorsListenersEnv) NewHCSR501Listener(listenerName string, urlString string) (*listeners.Listener, error) {
	...
	var f mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
		...
		// unmashal payload
		measurement := &sensors.HCSR501Measurement{}
		...
		if err == nil {
			err = e.persistence.CreateHCSR501Measurement(measurement)
